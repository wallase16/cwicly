 ...
 */
function cwicly_navmenu_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_navmenu_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_navmenu_register' );
 ...
 * @return string
 */
function cc_navmenu_render_callback( $attributes, $content, $block ) {
