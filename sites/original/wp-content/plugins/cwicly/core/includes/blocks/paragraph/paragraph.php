 ...
 */
function cwicly_paragraph_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_paragraph_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_paragraph_register' );
 ...
 * @return string
 */
function cc_paragraph_render_callback( $attributes, $content, $block ) {
