 ...
 */
function cwicly_taxonomyterms_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_taxonomyterms_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_taxonomyterms_register' );
 ...
 * @return string
 */
function cc_taxonomyterms_render_callback( $attributes, $content, $block ) {
