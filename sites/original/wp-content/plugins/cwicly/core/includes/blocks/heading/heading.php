 ...
 */
function cwicly_heading_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_heading_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_heading_register' );
 ...
 * @return string
 */
function cc_heading_render_callback( $attributes, $content, $block ) {
