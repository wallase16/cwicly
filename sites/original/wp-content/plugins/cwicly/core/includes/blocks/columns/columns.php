 ...
 */
function cwicly_columns_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_columns_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_columns_register' );
 ...
 * @return string
 */
function cc_columns_render_callback( $attributes, $content, $block ) {
