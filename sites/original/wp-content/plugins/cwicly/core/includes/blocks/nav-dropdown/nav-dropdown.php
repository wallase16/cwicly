 ...
 */
function cwicly_navdropdown_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_navdropdown_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_navdropdown_register' );
 ...
 * @return string
 */
function cc_navdropdown_render_callback( $attributes, $content, $block ) {
