 ...
 */
function cwicly_navitems_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_navitems_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_navitems_register' );
 ...
 * @return string
 */
function cc_navitems_render_callback( $attributes, $content, $block ) {
