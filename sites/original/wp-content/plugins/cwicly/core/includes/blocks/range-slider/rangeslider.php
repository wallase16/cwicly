 ...
 */
function cwicly_rangeslider_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_rangeslider_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_rangeslider_register' );
 ...
 * @return string
 */
function cc_rangeslider_render_callback( $attributes, $content, $block ) {
