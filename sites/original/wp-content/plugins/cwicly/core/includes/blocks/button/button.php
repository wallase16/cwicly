 ...
 */
function cwicly_button_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_button_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_button_register' );
 ...
 * @return string
 */
function cc_button_render_callback( $attributes, $content, $block ) {
