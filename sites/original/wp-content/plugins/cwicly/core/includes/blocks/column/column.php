 ...
 */
function cwicly_column_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_column_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_column_register' );
 ...
 * @return string
 */
function cc_column_render_callback( $attributes, $content, $block ) {
