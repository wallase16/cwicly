 ...
 */
function cwicly_querytemplate_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_query_template_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_querytemplate_register' );
 ...
 * @return string
 */
function cc_query_template_render_callback( $attributes, $content, $block ) {
