 ...
 */
function cwicly_accordions_register() {
	register_block_type(
		__DIR__,
		array(
			'render_callback' => 'cc_accordions_render_callback',
		)
	);
}
add_action( 'init', 'cwicly_accordions_register' );
 ...
 * @return string
 */
function cc_accordions_render_callback( $attributes, $content, $block ) {
